...
<script>
const VIDEOS = [
  { title:"Instalación ubuntu", thumb:"favicon.png", src:"ubuntu.mp4" },
  { title:"Montaje de PC", thumb:"favicon.png", src:"videos/pc.mp4" },
  { title:"Linux – Nivel Básico", thumb:"favicon.png", src:"videos/linux.mp4" },
  { title:"Curso Redes — Parte 1", thumb:"favicon.png", src:"videos/redes1.mp4" },
  { title:"Instalación Windows 10", thumb:"favicon.png", src:"ubuntu.mp4" },
  { title:"Instalación Windows 10", thumb:"favicon.png", src:"ubuntu.mp4" }
];
